...
The **Document Intelligence API** is a Python-based backend that enables intelligent document ingestion, analysis, and semantic search. It combines **FastAPI**, **Celery**, and **AI-powered NLP models** to extract insights from uploaded files and provide structured responses through REST endpoints.

---

## Sample of a response generated by the service for PDF document
